...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // MẪU SỔ KẾ TOÁN S1a-HKD (Theo TT 152/2025/TT-BTC)
        $defaultLedger = <<<HTML
        <div style="font-family: 'DejaVu Sans', sans-serif; font-size: 13px; line-height: 1.5; color: #000; padding: 20px;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 20px;">
                <tr>
                    <td width="60%" valign="top">
                        <strong style="font-size: 14px; text-transform: uppercase;">HỘ, CÁ NHÂN KINH DOANH: {{PROPERTY_NAME}}</strong><br>
                        Địa chỉ: {{PROPERTY_ADDRESS}}<br>
                        Mã số thuế: ............................................
                    </td>
            ...
            <p style="text-align: center; font-style: italic; margin-bottom: 5px;">Địa điểm kinh doanh: {{PROPERTY_ADDRESS}}</p>
            <p style="text-align: center; font-style: italic; margin-bottom: 20px;">Kỳ kê khai: {{PERIOD_LABEL}}</p>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 30px;">
                <tr>
                    ...
                    <td width="50%" align="center">
                        <i style="font-size: 13px;">Ngày {{CURRENT_DAY}} tháng {{CURRENT_MONTH}} năm {{CURRENT_YEAR}}</i><br>
        ...
        Setting::updateOrCreate(
            ['user_id' => null, 'key' => 'ledger_template'],
            ['value' => $defaultLedger]
        );
