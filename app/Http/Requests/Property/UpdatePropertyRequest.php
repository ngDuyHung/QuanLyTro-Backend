...
class UpdatePropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'floors_count' => ['sometimes', 'required', 'integer', 'min:0', 'max:200'],
    ...
    public function messages(): array
    {
        return [
            ...
            'floors_count.max' => 'Số tầng không vượt quá 200.',
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->has('manager_name')) {
            $data['manager_name'] = $this->manager_name
