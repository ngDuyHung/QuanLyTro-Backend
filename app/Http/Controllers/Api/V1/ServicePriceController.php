...
class ServicePriceController extends Controller
{
    ...
    {
        $servicePrices = ServicePrice::whereNull('property_id')
            ->latest()
    ...
    public function index(Request $request, int $propertyId): JsonResponse
    {
        ...
        $propertyPrices = ServicePrice::where('property_id', $propertyId)
            ->get()
        ...
        $globalPrices = ServicePrice::whereNull('property_id')
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        $servicePrice->load('priceHistories');
    ...
    public function update(UpdateServicePriceRequest $request, int $id): JsonResponse
    {
        ...
        if ($request->has('unit_price') && $request->unit_price !== $oldUnitPrice) {
